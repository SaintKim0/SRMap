...
def save_to_csv(restaurants, output_file='백종원_광주.csv'):
    """식당 데이터를 CSV 파일로 저장"""
...
if __name__ == '__main__':
    html_file = '광주 백종원의3대천왕 맛집 Top7 - 다이닝코드.html'
    
    print("="*60)
    print("Extracting 백종원의3대천왕 광주 Restaurant Data")
    print("="*60)
