...
def save_to_csv(restaurants, output_file='전참시_서울.csv'):
    """식당 데이터를 CSV 파일로 저장"""
...
if __name__ == '__main__':
    html_file = '서울 전지적참견시점 맛집 Top100 - 다이닝코드.html'
    
    print("="*60)
    print("Extracting 전지적참견시점 서울 Restaurant Data")
    print("="*60)
