...
def save_to_csv(restaurants, output_file='허영만_서울.csv'):
    """식당 데이터를 CSV 파일로 저장"""
...
if __name__ == '__main__':
    html_file = '서울 식객허영만의백반기행 맛집 Top100 - 다이닝코드.html'
    
    print("="*60)
    print("Extracting 식객허영만의백반기행 서울 Restaurant Data")
    print("="*60)
