...
def save_to_csv(restaurants, output_file='허영만_대전.csv'):
    """식당 데이터를 CSV 파일로 저장"""
...
if __name__ == '__main__':
    html_file = '대전 식객허영만의백반기행 맛집 Top18 - 다이닝코드.html'
    
    print("="*60)
    print("Extracting 식객허영만의백반기행 대전 Restaurant Data")
    print("="*60)
