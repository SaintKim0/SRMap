...
def save_to_csv(restaurants, output_file='성시경_경상.csv'):
    """식당 데이터를 CSV 파일로 저장"""
...
if __name__ == '__main__':
    html_file = '경상 성시경의먹을텐데 맛집 Top21 - 다이닝코드.html'
    
    print("="*60)
    print("Extracting 성시경의먹을텐데 경상 Restaurant Data")
    print("="*60)
