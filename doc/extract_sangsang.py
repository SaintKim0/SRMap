...
def save_to_csv(restaurants, output_file='sangsang.csv'):
    """식당 데이터를 CSV 파일로 저장"""
...
if __name__ == '__main__':
    html_file = '경기도 생생정보통 맛집 Top100 - 다이닝코드.html'
    
    print("="*60)
    print("Extracting 생생정보통 Restaurant Data from HTML Cards")
    print("="*60)
