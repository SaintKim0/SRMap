...
def save_to_csv(restaurants, output_file='성시경_광주.csv'):
    """식당 데이터를 CSV 파일로 저장"""
...
if __name__ == '__main__':
    html_file = '광주 성시경의먹을텐데 맛집 Top3 - 다이닝코드.html'
    
    print("="*60)
    print("Extracting 성시경의먹을텐데 광주 Restaurant Data")
    print("="*60)
