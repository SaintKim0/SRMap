...
def save_to_csv(restaurants, output_file='허영만_대구.csv'):
    """식당 데이터를 CSV 파일로 저장"""
...
if __name__ == '__main__':
    html_file = '대구 식객허영만의백반기행 맛집 Top22 - 다이닝코드.html'
    
    print("="*60)
    print("Extracting 식객허영만의백반기행 대구 Restaurant Data")
    print("="*60)
