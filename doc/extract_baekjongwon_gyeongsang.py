...
def save_to_csv(restaurants, output_file='백종원_경상.csv'):
    """식당 데이터를 CSV 파일로 저장"""
...
if __name__ == '__main__':
    html_file = '경상 백종원의3대천왕 맛집 Top70 - 다이닝코드.html'
    
    print("="*60)
    print("Extracting 백종원의3대천왕 경상 Restaurant Data")
    print("="*60)
