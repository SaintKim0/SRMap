...
class LocationRepository {
  ...
  Map<String, dynamic> _toMap(Location location) {
    return {
      ...
      'chef_name': location.chefName,
      'food_category': location.foodCategory,
      'representative_menu': location.representativeMenu,
  ...
  Location _fromMap(Map<String, dynamic> map) {
    return Location(
      ...
      representativeMenu: map['representative_menu'] as String?,
